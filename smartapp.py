...
# استبدل قسم CSS بالكامل بهذا الكود المبسط والمضمون
st.markdown("""
<style>
    /* تنسيق البطاقات - قوي ومضمون */
        ...
        if st.button("✅ Confirm Subscription", type="primary"):
            ...
            # Validate expiry date format (MM/YY)
                ...
                if renewal_date < today:
                    st.error("❌ Renewal date cannot be in the past! Please select a future date.")
